...
DEPICTION_URL="https://repo.abox.plus/depictions/index.html?packageId=$PACKAGE_IDENTIFIER"
ICON_URL="https://repo.abox.plus/api/packageinfo/$PACKAGE_IDENTIFIER/icon.png"
SILEO_DEPICTION_URL="https://repo.abox.plus/depictions/native/$PACKAGE_IDENTIFIER.json"
